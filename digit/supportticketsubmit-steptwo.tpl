<div class="wdes-block">
    ...
    <form method="post" action="{$smarty.server.PHP_SELF}?step=3" enctype="multipart/form-data" role="form">
        ...
        <p class="text-center">
            <input type="submit" id="openTicketSubmit" value="{$LANG.supportticketsticketsubmit}" class="wdes-submit{$captcha->getButtonClass($captchaForm)}" />
            <a href="supporttickets.php" class="wdes-2nd-btn">{$LANG.cancel}</a>
        </p>
