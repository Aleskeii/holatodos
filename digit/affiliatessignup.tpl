<div class="wdes-block">
    {if $affiliatesystemenabled}
        ...
        {include file="$template/includes/alert.tpl" type="wdes-info" title=$LANG.affiliatesignuptitle msg=$LANG.affiliatesignupintro|cat:'<br /><br />' textcenter=true}

        <ul class="alert-wdes-info">
